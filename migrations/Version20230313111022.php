 ...
 */
final class Version20230313111022 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE avis (id INT AUTO_INCREMENT NOT NULL, users_id INT NOT NULL, jeux_id INT NOT NULL, note INT NOT NULL, commentaire TEXT(5000) NOT NULL, is_valid TINYINT(1) NOT NULL, INDEX IDX_8F91ABF067B3B43D (users_id), INDEX IDX_8F91ABF0EC2AA9D2 (jeux_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE jeux (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(100) NOT NULL, url VARCHAR(255) NOT NULL, description TEXT(5000) NOT NULL, img VARCHAR(255) DEFAULT NULL, note NUMERIC(2, 1) DEFAULT NULL, date_sortie DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE avis ADD CONSTRAINT FK_8F91ABF067B3B43D FOREIGN KEY (users_id) REFERENCES utilisateurs (id)');
